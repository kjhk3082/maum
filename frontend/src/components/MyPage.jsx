  ...
  return (
    ...
    >
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        {/* 프로필 섹션 */}
        <div
          className="mb-8 p-8 rounded-3xl backdrop-blur-sm shadow-xl"
          style={{
            background: isDarkMode
          ...
          <div className="flex flex-col items-center">
            ...
            >
              <div
                ...
                style={{ background: 'linear-gradient(145deg, #17A2B8, #138496)' }}
              >
                <img
                  src={
                    user?.profileImage ||
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4">
                <input
                  ...
                  onFocus={e => {
                    ...
                    e.currentTarget.style.boxShadow = '0 0 0 4px rgba(23,162,184,0.1)'
                  }}
                  onBlur={e => {
        ...
        <div className="space-y-6">
          ...
          >
            ...
            <div className="flex items-center gap-3">
              ...
              >
                {isDarkMode ? <Moon size={28} color="#94a3b8" /> : <Sun size={28} color="white" />}
              </div>
              <span
                style={{
                  fontSize: '16px',
