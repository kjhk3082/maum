...
- 조사 결합: 단어 뒤에 붙는 조사(예: 은/는, 이/가, 을/를, 에/에서, 으로/로 등)는 단어의 받침 유무를 고려해 자연스럽게 연결되도록 할 것. 어색한 표현(예: "비으로")은 절대 사용하지 말 것.
+ 조사 결합 시, 한국어 문법에 따라 받침이 없으면 '로', 받침이 있으면 '으로'를 사용해야 하며, 예외 단어인 ‘도로, 바로, 사로, 비로’ 등은 사전에 반드시 조사 판단 후 결정할 것.
